package scene.tilemap_3;

import openfl.ui.Keyboard;
import ngawung.display.tilemap.TileMap;
import ngawung.display.tilemap.TileConfig;
import ngawung.display.tilemap.TileLayer;
import ngawung.core.Scene;

class Tilemap_3 extends Scene {
